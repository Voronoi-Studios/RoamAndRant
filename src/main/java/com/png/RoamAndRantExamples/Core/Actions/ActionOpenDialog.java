...
public class ActionOpenDialog extends ActionBase {
    @Nonnull
    protected final String dialogId;

    public ActionOpenDialog(@Nonnull BuilderActionOpenDialog builder, @Nonnull BuilderSupport support) {
        super(builder);
        ...
        if (playerReference == null) {
            ...
            if (playerRefComponent == null) {
                ...
                if (playerComponent == null) {
                    ...
                    playerComponent.getPageManager().openCustomPage(ref, store, new UIDialogPage(npcComponent, playerRefComponent, dialogId));
                    return true;
                }
            }
        }
